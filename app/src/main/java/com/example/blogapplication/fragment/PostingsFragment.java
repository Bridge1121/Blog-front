...
//        mRecyclerView.addHeaderView(loadMoreView);  // 无效
    ...
    private void loadMoreItems() {
        ...
        apiService.postingslist(currentPage, pageSize,TokenUtils.getUserInfo(getContext()).getId()).enqueue(new Callback<ResponseResult<UserPostingsResponse>>() {
            @Override
            public void onResponse(Call<ResponseResult<UserPostingsResponse>> call, Response<ResponseResult<UserPostingsResponse>> response) {
    ...
    private void initView() {
        ...
        apiService.postingslist(1, 10,TokenUtils.getUserInfo(getContext()).getId()).enqueue(new Callback<ResponseResult<UserPostingsResponse>>() {
            @Override
            public void onResponse(Call<ResponseResult<UserPostingsResponse>> call, Response<ResponseResult<UserPostingsResponse>> response) {
                postingsVos = response.body().getData().getRows();
