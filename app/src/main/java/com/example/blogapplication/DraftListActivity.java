        ...
        SwipeMenuCreator mSwipeMenuCreator = new SwipeMenuCreator() {
            ...
            public void onCreateMenu(SwipeMenu leftMenu, SwipeMenu rightMenu, int position) {
                SwipeMenuItem deleteItem = new SwipeMenuItem(getApplicationContext())
                        .setBackground(com.github.florent37.materialviewpager.R.color.material_grey_100)//菜单背景
                        .setImage(R.drawable.ic_delete_black_20dp)//菜单图标
                        .setWidth(120)//菜单宽度
                        .setHeight(80);//菜单高度
                ;
...
//        swipeRecyclerView.setLongPressDragEnabled(true);//拖拽排序
